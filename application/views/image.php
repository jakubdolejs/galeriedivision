            ...
            function loadImage(id) {
                ...
                for (var i=0; i<images.length; i++) {
                    if (images[i].id == id) {
                        ...
                        var dimensions = [];
                        if (images[i].hasOwnProperty("height")) {
                            dimensions.push(images[i].height+'"');
                        }
                        if (images[i].hasOwnProperty("width")) {
                            dimensions.push(images[i].width+'"');
                        }
                        if (images[i].hasOwnProperty("depth")) {
                            dimensions.push(images[i].depth+'"');
                        }
